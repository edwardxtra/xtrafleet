  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-sm max-w-none space-y-6 dark:prose-invert">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">2. Account Verification</h2>
          
          <h3 className="text-lg font-semibold mt-3">All Carriers must provide:</h3>
          ...
          <h3 className="text-lg font-semibold mt-3">Drivers must provide:</h3>
          <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">3. Role Definitions</h2>
          <ul className="list-disc pl-6 space-y-2 text-sm text-muted-foreground">
            <li>
              <strong className="text-foreground">Fleet A (Lessor Carrier):</strong> A motor carrier that supplies 
              a qualified driver to another carrier.
            </li>
            <li>
              <strong className="text-foreground">Fleet B (Lessee Carrier):</strong> A motor carrier that temporarily 
              leases a driver from Fleet A for a specific trip.
            </li>
            <li>
              <strong className="text-foreground">Driver:</strong> The individual authorized by Fleet A and accepted 
              by Fleet B for the defined lease period.
            </li>
          </ul>
        </section>

        <section className="space-y-4">
          <h2 className="text-xl font-semibold">4. Compliance Attestation</h2>
          <p className="text-sm text-muted-foreground">
            By using the Platform, each Carrier certifies that:
          </p>
          <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">5. Data Sharing and Privacy</h2>
          <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">6. Ratings & Reviews</h2>
          <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">7. Insurance Confirmation (Digital Checkbox)</h2>
          <p className="text-sm text-muted-foreground">
            Before initiating any trip or lease, Fleet B must complete the following:
          </p>
          <div className="pl-6 space-y-2 text-sm text-muted-foreground">
            <p>☐ I confirm that my existing insurance policy covers leased or temporary drivers for the duration of this trip.</p>
            <p>☐ I elect to purchase trip-based coverage through an approved XtraFleet third-party partner.</p>
          </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">8. Conduct, Cancellations, and Penalties</h2>
          <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            XtraFleet may suspend or terminate access for:
          </p>
          <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">10. Acknowledgment</h2>
          <div className="p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg">
            <p className="text-sm font-medium text-foreground">
              By checking acceptance, each Carrier acknowledges:
            </p>
            <p className="text-sm text-muted-foreground mt-2">
              "I understand XtraFleet is a technology platform that facilitates carrier-to-carrier driver lease 
              transactions and does not act as a broker, employer, or carrier."
            </p>
          </div>
        </section>
      </div>
